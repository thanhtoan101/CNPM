% ==========================================
% 3.2.f SẢN PHẨM BÀN GIAO DỰ KIẾN
% ==========================================

\section*{3.2.f Sản phẩm bàn giao dự kiến}
\addcontentsline{toc}{section}{3.2.f Sản phẩm bàn giao dự kiến}
...
\subsection*{Ứng dụng di động dành cho nhiếp ảnh gia}
...
\subsection*{Cổng thông tin web quản lý cơ sở xử lý phim}
...
\subsection*{Hệ thống quản trị web}
...
\subsection*{Mô-đun sàn giao dịch}
...
\subsection*{Nền tảng cộng đồng và chia sẻ kiến thức}
...
\subsection*{Hệ thống quản lý kho lưu trữ phim kỹ thuật số}
...
\subsection*{Hệ thống đề xuất AI}
...
\subsection*{Trợ lý nhiếp ảnh ứng dụng AI}
...
\subsection*{Dịch vụ phía máy chủ và hạ tầng đám mây}
...
\subsection*{Minh chứng bàn giao}
