...
\input{sections/08-system-architecture.tex}
\input{sections/09-technology-stack.tex}
\input{sections/14-database-storage-architecture.tex}
\clearpage
\input{sections/10-mobile-web-design.tex}
\clearpage
\chapter{Prototype Handover and Verification}
\input{sections/11-prototype-handover.tex}
\clearpage
\input{sections/12-verification-evidence.tex}
\end{document}
